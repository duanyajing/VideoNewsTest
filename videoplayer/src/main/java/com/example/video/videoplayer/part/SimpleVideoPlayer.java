package com.example.video.videoplayer.part;
...
import com.example.video.videoplayer.R;
import com.example.video.videoplayer.full.VideoViewActivity;
...
/**
 * 一个自定义的VideoPlayer，使用Medioplayer+SurfaceView来实现视频的播放
 * 使用Medioplayer来做视频播放的控制，SurfaceView用来显示视频
 * 视图：一个播放，暂停按钮，一个进度条，一个全屏按钮，一个SurfaceView
 *
 * 结构：
 * 提供setVideoPath方法：设置数据源
 * 提供OnResume方法（在activity的OnResume方法中调用）
 */
